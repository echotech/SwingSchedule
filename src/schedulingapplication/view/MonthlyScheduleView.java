 ...
 *
 */
public class MonthlyScheduleView extends JFrame {

    private LocalDate curDate;

    public MonthlyScheduleView(String title) {
        super(title);
        initComponents();
    ...
    private void initComponents() {
        ...
        JPanel jpCenter = new JPanel(new GridLayout(6, 7));
    ...
    private void updateMonth(JPanel[] jpDays, JLabel jlMonth) throws Exception {
        ...
        jlMonth.setText(curMonth.name() + ", " + curDate.getYear());
//        LocalDate firstDay = ldNow.minus(ldNow.getDayOfMonth() - 1, ChronoUnit.DAYS);
        LocalDate firstDay = curDate.with(TemporalAdjusters.firstDayOfMonth());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new MonthlyScheduleView(("Monthly View")).setVisible(true);
        });
    }
}
